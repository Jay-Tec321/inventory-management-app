This is a simple Inventory Management Application built using Python and the Tkinter GUI library. The app is designed to help users manage their inventory by allowing them to:
